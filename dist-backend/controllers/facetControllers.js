...
// =====================
const createFacetHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateFacetHandler = (req, res) => {
    try {
        const { facetId } = req.params;
        const facet = facet_1.Facet.fromRequestObject(Object.assign(Object.assign({}, req.body), { facetId }));
...
// =====================
const setFacetDistanceHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getFacetDistanceHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { sourceFacetId, targetFacetId } = req.params;
...
const getClosestFacetsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { facetId } = req.params;
...
// =====================
const createFacetBridgeHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getAllBridgesHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res
            .status(410)
            .json({ success: false, error: 'Facet bridges are deprecated' });
...
const getBridgeByIdHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const findAvailableBridgesHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// =====================
const submitFeedbackHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getFeedbackHistoryHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// =====================
const suggestTransitionsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const calculateTransitionCompatibilityHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// System Controllers
// =====================
const initializeFacetSystemHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
