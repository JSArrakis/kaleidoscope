...
const progressionManager = __importStar(require("../services/progressionManager"));
...
function gatherCandidatesForFacet(facet_1) {
    return __awaiter(this, arguments, void 0, function* (facet, options = {}) {
        if (!facet)
            return [];
        ...
        const pushMatches = (items, mediaType) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const m of items) {
                ...
                if (mediaType === 'show' && maxDurationMinutes) {
                    ...
                    try {
                        const progression = yield progressionManager.GetShowProgression(m.mediaItemId, streamTypes_1.StreamType.Cont);
                        if (progression === null || progression === void 0 ? void 0 : progression.nextEpisodeOverDuration) {
        ...
        yield pushMatches(movies, 'movie');
        yield pushMatches(shows, 'show');
        return candidates;
    });
}
...
function refractFromMedia(media_1) {
    return __awaiter(this, arguments, void 0, function* (media, options = {}, bridgeLogger = logBridge) {
        ...
        const candidates = yield gatherCandidatesForFacet(targetFacet, options);
