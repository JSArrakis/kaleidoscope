...
function findMusicVideosWithPriority(tagsByPriority_1, targetMusicalGenres_1) {
    return __awaiter(this, arguments, void 0, function* (tagsByPriority, targetMusicalGenres, options = {}) {
...
function selectMusicFromFacets(facetIds_1, adjacentMedia_1) {
    return __awaiter(this, arguments, void 0, function* (facetIds, adjacentMedia, // The media that will be adjacent to the selected music
    options = {}) {
        ...
        const { candidates, priorityUsed } = yield findMusicVideosWithPriority(tagsByPriority, selectedMosaic.musicalGenres, options);
        if (candidates.length === 0) {
            return {
                selectedMusic: null,
        ...
        if (priorityUsed === tagTypes_1.TagType.Specialty &&
            ...
            const nonSpecialtyCandidates = yield findMusicVideosWithPriority(tagsByPriority, selectedMosaic.musicalGenres, options);
