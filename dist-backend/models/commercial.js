...
class Commercial {
    ...
    static fromRequestObject(requestObject) {
        return __awaiter(this, void 0, void 0, function* () {
            const { tagRepository } = yield Promise.resolve().then(() => __importStar(require('../repositories/tagsRepository')));
            ...
            return new Commercial(requestObject.title, requestObject.mediaItemId, requestObject.duration, requestObject.path, mediaTypes_1.MediaType.Commercial, tags);
        });
    }
}
