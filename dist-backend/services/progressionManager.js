...
const progressionContext_1 = require("../models/progressionContext");
const utilities_1 = require("../utils/utilities");
const progressionRepository_1 = require("../repositories/progressionRepository");
...
function ManageShowProgression(show_1, numberOfEpisodes_1, args_1, streamType_1) {
    return __awaiter(this, arguments, void 0, function* (show, numberOfEpisodes, args, streamType, collection = '') {
        ...
        let progression = yield progressionRepository_1.progressionRepository.findProgression(showMediaItemId, streamType);
        if (!progression) {
            ...
            false);
            yield progressionRepository_1.progressionRepository.upsertProgression(progression);
        }
...
function UpdateEpisodeProgression(showMediaItemId, streamType, episodeNumber, show) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        // This function should be called by the background service when an episode finishes playing
        const progression = yield progressionRepository_1.progressionRepository.findProgression(showMediaItemId, streamType);
        if (progression) {
            ...
            const nextEpisodeData = (_a = show.episodes) === null || _a === void 0 ? void 0 : _a.find(ep => ep.episodeNumber === nextEpisode);
            progression.nextEpisodeOverDuration =
                (nextEpisodeData === null || nextEpisodeData === void 0 ? void 0 : nextEpisodeData.overDuration) || false;
            progression.nextEpisodeDurLimit =
                (nextEpisodeData === null || nextEpisodeData === void 0 ? void 0 : nextEpisodeData.duration) || show.durationLimit;
            yield progressionRepository_1.progressionRepository.upsertProgression(progression);
        }
    });
}
...
function GetShowListProgressions(shows, streamType) {
    return __awaiter(this, void 0, void 0, function* () {
        const progressions = [];
...
function IsNextEpisodeOverDuration(showMediaItemId, streamType) {
    return __awaiter(this, void 0, void 0, function* () {
        const progression = yield progressionRepository_1.progressionRepository.findProgression(showMediaItemId, streamType);
        return (progression === null || progression === void 0 ? void 0 : progression.nextEpisodeOverDuration) || false;
    });
}
