...
const streamMan = __importStar(require("./streamManager"));
...
function cycleCheck() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (onDeck.length >= 1 && currentUnixTimestamp === onDeck[0].startTime) {
            console.log(((_a = onDeck[0].featureMedia) === null || _a === void 0 ? void 0 : _a.title) + ' is starting now');
        }
            ...
            if (onDeck[1].startTime && currentUnixTimestamp >= onDeck[1].startTime) {
                ...
                if (removed != null || removed != undefined) {
                    console.log('Removing ' +
                        ((_b = removed.featureMedia) === null || _b === void 0 ? void 0 : _b.title) +
                ...
                if (nextMediaBlock != null || nextMediaBlock != undefined) {
                    console.log('Adding ' + ((_c = nextMediaBlock.featureMedia) === null || _c === void 0 ? void 0 : _c.title) + ' to On Deck Stream');
                }
                ...
                if (nextMediaBlock != null || nextMediaBlock != undefined) {
                    ...
                    yield vlcService.addMediaBlockToPlaylist(nextMediaBlock);
                }
            }
        }
