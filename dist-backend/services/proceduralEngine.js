...
function getProceduralBlock(args, stagedMedia, media, prevMovies, duration, latestTimePoint, streamType) {
            ...
            if (injDurMovies.length > 0) {
                ...
                if (durRemainder >= 5400) {
                    ...
                    if (Math.random() > 0.5 &&
                        ...
                        let result = yield getEpisodesUnderDuration(args, media.shows, durRemainder, streamType);
...
function getEpisodesUnderDuration(args, shows, duration, streamType) {
    return __awaiter(this, void 0, void 0, function* () {
        let episodes = [];
        ...
        let [selectedShow, numberOfEpisodes] = yield selectShowByDuration(args, duration, filteredShows, streamType);
        ...
        let episodeIndicies = yield (0, progressionManager_1.ManageShowProgression)(selectedShow, numberOfEpisodes, args, streamType);
...
function selectShowByDuration(args, duration, shows, streamType) {
    return __awaiter(this, void 0, void 0, function* () {
        let progressions = yield (0, progressionManager_1.GetShowListProgressions)(shows, streamType);
        let selectedShows = [];
        ...
        if (duration < 3600) {
            ...
            minProgressions = minProgressions.filter(prog => {
                ...
                if (show !== undefined) {
                    ...
                    let nextNextEpisode = (_a = show.episodes) === null || _a === void 0 ? void 0 : _a.find(ep => ep.episodeNumber === episodeNumber);
