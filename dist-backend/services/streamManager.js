...
const streamConstructor_1 = require("./streamConstructor");
const streamTypes_1 = require("../models/enum/streamTypes");
const moment_1 = __importDefault(require("moment"));
const bufferEngine_1 = require("./bufferEngine");
...
const vlcService = __importStar(require("./vlcService"));
...
function initializeStream(config_1, streamArgs_1, streamType_1) {
    return __awaiter(this, arguments, void 0, function* (config, streamArgs, streamType, cadence = false) {
        ...
        // Plex and Jellyfin
        yield vlcService.initializeVLCService(getContinuousStreamArgs().Password);
        yield addInitialMediaBlocks();
...
function addInitialMediaBlocks() {
    return __awaiter(this, void 0, void 0, function* () {
        for (const item of onDeck) {
            yield vlcService.addMediaBlockToPlaylist(item);
        }
    });
}
