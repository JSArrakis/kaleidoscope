...
const showCont = __importStar(require("../controllers/showControllers.cjs"));
const movCont = __importStar(require("../controllers/movieControllers.cjs"));
const commCont = __importStar(require("../controllers/commercialControllers.cjs"));
const shortCont = __importStar(require("../controllers/shortControllers.cjs"));
const musicCont = __importStar(require("../controllers/musicControllers.cjs"));
const promoCont = __importStar(require("../controllers/promoControllers.cjs"));
const bumperCont = __importStar(require("../controllers/bumperControllers.cjs"));
const collectionCont = __importStar(require("../controllers/collectionControllers.cjs"));
const tagCont = __importStar(require("../controllers/tagControllers.cjs"));
// import * as blockCont from '../controllers/blockControllers';
const statusCont = __importStar(require("../controllers/statusControllers.cjs"));
const facetCont = __importStar(require("../controllers/facetControllers.cjs"));
const verify = __importStar(require("../middleware/validationMiddleware.cjs"));
