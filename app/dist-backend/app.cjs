...
const db_1 = require("./db/db.cjs");
const backgroundService_1 = require("./services/backgroundService.cjs");
const config_1 = require("./models/config.cjs");
...
const adminRoutes_1 = __importDefault(require("./routes/adminRoutes.cjs"));
const streamRoutes_1 = __importDefault(require("./routes/streamRoutes.cjs"));
