 ...
 */
export async function createStream(streamType, streamConstructionOptions, startTimepoint, endTimepoint) {
    switch (streamType) {
        ...
        case StreamType.Adhoc:
            ...
            return buildAdhocStream(streamConstructionOptions, startTimepoint, endTimepoint);
        default:
