...
export function getAllCommercials() {
    return commercialRepository.findAll();
}
export function getCommercial(mediaItemId) {
    if (!mediaItemId) {
...
export function updateCommercial(mediaItemId, updates) {
    try {
        if (!mediaItemId) {
            return { message: "Media Item ID is required", status: 400 };
        }
...
export function deleteCommercial(mediaItemId) {
    try {
        if (!mediaItemId) {
            return { message: "Media Item ID is required", status: 400 };
        }
