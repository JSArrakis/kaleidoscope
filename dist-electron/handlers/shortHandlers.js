...
export async function getShortsHandler() {
    console.log("[shortHandler] IPC: getShorts");
    return shortController.getAllShorts();
}
export async function createShortHandler(short) {
